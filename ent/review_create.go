...
func (rc *ReviewCreate) SetUserID(i int) *ReviewCreate {
	rc.mutation.SetUserID(i)
	return rc
}

// SetStoreID sets the "store_id" field.
func (rc *ReviewCreate) SetStoreID(i int) *ReviewCreate {
...
func (rc *ReviewCreate) SetStore(s *Store) *ReviewCreate {
...
func (rc *ReviewCreate) check() error {
	...
	if _, ok := rc.mutation.StoreID(); !ok {
		return &ValidationError{Name: "store_id", err: errors.New(`ent: missing required field "Review.store_id"`)}
	}
	...
	if len(rc.mutation.StoreIDs()) == 0 {
		return &ValidationError{Name: "store", err: errors.New(`ent: missing required edge "Review.store"`)}
	}
	return nil
}
